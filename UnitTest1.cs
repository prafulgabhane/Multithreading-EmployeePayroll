namespace EmpPayrollProject
{
    public class Tests
    {
        ...
        public void GivenEmployeeList_InAddingEmployeeMethod_ReturnSameListThatisAdded()
        {
            ...
            employeesListToBeAddedToDB.Add(new EmployeePayroll { name = "Vaibhav", salary = 30000, startdate = DateTime.Now, phone = 7777777777, address = "Nagpur", BasicPay = 30000, Deductions = 2000, TaxablePay = 1000, IncomeTax = 500, NetPay = 21500, DepartmentID = 2});
            ...
            employeesListToBeAddedToDB.Add(new EmployeePayroll { name = "Shubham", salary = 40000, startdate = DateTime.Now, phone = 86429532174, address = "Tumsar", BasicPay = 25000, Deductions = 1000, TaxablePay = 500, IncomeTax = 500, NetPay = 23000, DepartmentID = 1 });
            employeesListToBeAddedToDB.Add(new EmployeePayroll { name = "Praful", salary = 28000, startdate = DateTime.Now, phone = 7485321696, address = "Sagar", BasicPay = 18000, Deductions = 1000, TaxablePay = 500, IncomeTax = 500, NetPay = 17000, DepartmentID = 2 });
            employeesListToBeAddedToDB.Add(new EmployeePayroll { name = "Sai", salary = 40000, startdate = DateTime.Now, phone = 9652385137, address = "Yerli", BasicPay = 35000, Deductions = 1000, TaxablePay = 500, IncomeTax = 500, NetPay = 33000, DepartmentID = 2 });
            ...
            employeesListToBeAddedToDB.Add(new EmployeePayroll { name = "Kalyani", salary = 22000, startdate = DateTime.Now, phone = 7958623485, address = "Mirjan", BasicPay = 26000, Deductions = 1000, TaxablePay = 500, IncomeTax = 500, NetPay = 25000, DepartmentID = 3 });
