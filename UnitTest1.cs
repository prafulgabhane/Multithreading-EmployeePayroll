...
namespace EmpPayrollProject
{
    ...
    public class UnitTest1
    {
        ...
        public void Given10Employee_WhenAddedToList_ShouldMaatchEmployeeEntries()
        {
            ...
            employeeDetails.Add(new EmployeeDetails(EmployeeID: 4, EmployeeName: "Praful", PhoneNumber: "9999999999", Address: "Tumsar", Department: "Engineer", Gender: 'M', BasicPay: 10000, Deductions: 200, TaxablePay: 2000, Tax: 1000, NetPay: 6800, City: "Sagaon", Country: "India"));
